...
function Bar:Build(plugin, record)
    ...
    frame.NameText = frame.TextFrame:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
    ...
    frame.CountText = frame.TextFrame:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
