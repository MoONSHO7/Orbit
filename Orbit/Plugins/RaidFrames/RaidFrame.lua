...
local RAID_SKIN = Orbit.Constants.Aura.SkinWithTimer

local RAID_DEBUFF_CFG = {
    componentKey = "Debuffs",
    fetchFilter = "HARMFUL",
    fetchMax = 40,
    postFilter = RaidDebuffPostFilter,
    tooltipFilter = "HARMFUL",
    skinSettings = RAID_SKIN,
...
function Plugin:PrepareIconsForCanvasMode()
    ...
    Orbit.GroupCanvasRegistration:PrepareIcons(self, frame, {
        ...
        roleIcons = { "RoleIcon", "LeaderIcon", "MainTankIcon" },
        roleIconSize = ROLE_ICON_SIZE,
        defensiveSize = DEFENSIVE_ICON_SIZE,
        crowdControlSize = CROWD_CONTROL_ICON_SIZE,
        privateAuraSize = PRIVATE_AURA_ICON_SIZE,
        healerAuraSize = HEALER_AURA_ICON_SIZE, -- Default for PrepareIcons
