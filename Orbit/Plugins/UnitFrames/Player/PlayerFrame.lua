...
local Plugin = Orbit:RegisterPlugin("Player Frame", SYSTEM_ID, {
    ...
    defaults = {
        ...
        ComponentPositions = {
            ...
            LeaderIcon        = { anchorX = "LEFT",   offsetX = 10, anchorY = "TOP",    offsetY = 0,  justifyH = "LEFT",   selfAnchorY = "TOP",    posX = -70, posY = 19,  overrides = { Scale = 1.1, LeaderIconStyle = "header" } },
            MarkerIcon        = { anchorX = "CENTER", offsetX = 0,  anchorY = "TOP",    offsetY = 0,  justifyH = "CENTER", selfAnchorY = "TOP",    posX = 0,   posY = 19,  overrides = { Scale = 1 } },
            GroupPositionText = { anchorX = "RIGHT",  offsetX = -6, anchorY = "BOTTOM", offsetY = 8,  justifyH = "RIGHT",  selfAnchorY = "BOTTOM", posX = 78,  posY = -11 },
            RestingIcon       = { anchorX = "RIGHT",  offsetX = -2, anchorY = "TOP",    offsetY = -3, justifyH = "LEFT",   selfAnchorY = "TOP",    posX = 82,  posY = 22,  overrides = { Scale = 0.6 } },
            ...
            PvpIcon           = { anchorX = "RIGHT",  offsetX = 25, anchorY = "BOTTOM", offsetY = -5, justifyH = "RIGHT",  selfAnchorY = "BOTTOM", posX = 55,  posY = -24, overrides = { IconSize = 22 } },
        },
    },
})
