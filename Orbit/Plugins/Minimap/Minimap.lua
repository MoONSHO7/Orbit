...
local Plugin = Orbit:RegisterPlugin("Minimap", SYSTEM_ID, {
    ...
    defaults = {
        ...
        ComponentPositions = {
            ...
            Mail           = { anchorX = "RIGHT",  anchorY = "BOTTOM", offsetX = 15,  offsetY = 48, posX = 135,  posY = -102, justifyH = "RIGHT",  selfAnchorY = "BOTTOM" },
            DifficultyText = { anchorX = "LEFT",   anchorY = "TOP",    offsetX = 20,  offsetY = 20, posX = -105, posY = 105,  justifyH = "LEFT",   selfAnchorY = "TOP" },
            Clock          = { anchorX = "CENTER", anchorY = "BOTTOM", offsetX = 0,   offsetY = 15, posX = 0,    posY = -135, justifyH = "CENTER", selfAnchorY = "BOTTOM", overrides = { FontSize = 18 } },
            ZoneText       = { anchorX = "CENTER", anchorY = "TOP",    offsetX = 0,   offsetY = 15, posX = 0,    posY = 135,  justifyH = "CENTER", selfAnchorY = "TOP",    overrides = { FontSize = 24, ZoneTextColoring = true } },
        },
    },
})
