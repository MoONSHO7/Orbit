...
Orbit.Profile.defaults = {
    Layouts = {
        ["Orbit"] = {
            ...
            ["Orbit_HonorBar"] = {
                ["Orbit_HonorBar"] = {
                    Anchor = { align = "LEFT", target = "OrbitMinimapContainer", fallback = "OrbitMinimapContainer", edge = "BOTTOM", padding = 2 },
                    Width = 500, Height = 14, ValueMode = "percent", OnlyInPvP = true,
            ...
            ["Orbit_MinimapButton"] = {
                ["Orbit_MinimapButton"] = {
                    Anchor = false,
                    Position = { y = -191, x = -190, point = "TOPRIGHT" },
                },
            },
            ["Orbit_DamageMeter"] = {
                [1] = {
                ...
                [1] = {
                    ...
                    Tiers = {
                        Mythic = {
                            ...
                            Position = { y = -130, x = 54, point = "TOPLEFT" },
                            AggroThickness = 1,
                            PowerBarHeight = 16,
            ...
            ["Orbit_Datatexts"] = {
                [1] = {
                    datatextPositions = {
                        Performance = { placed = true, x = -551, y = 60, point = "BOTTOMRIGHT", scale = 1 },
                        Spec = { placed = true, x = 573, y = 56, point = "BOTTOMLEFT", scale = 1 },
                        Hearthstone = { placed = true, x = -502, y = 44, point = "BOTTOMRIGHT", scale = 1.23 },
