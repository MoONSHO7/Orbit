        ...
        ["Orbit"] = {
            ...
            ["Orbit_DamageMeter"] = {
                [1] = {
                    MeterDefs = {
                        [1] = {
                            id = 1, meterType = 0, sessionType = 0, viewMode = "chart",
                            barCount = 7, barWidth = 219, barHeight = 20, barGap = 1,
                            iconPosition = 1, style = 100, border = 3, background = 3,
                            title = 2, titleSize = 14, scrollOffset = 0, anchor = false,
                            position = { y = 132.38, x = -95.18, point = "BOTTOMRIGHT" },
                            disabledComponents = { "Status" },
                            componentPositions = {
                                Rank       = { posY = -1.51, offsetX = 3.54, justifyH = "LEFT",  posX = -91.13, selfAnchorY = "CENTER", overrides = { FontSize = 8 },  offsetY = 0, anchorX = "LEFT",  anchorY = "CENTER" },
                                ...
                                DPS        = { posY = 0,     offsetX = 52,   justifyH = "RIGHT", posX = 47.5,   selfAnchorY = "CENTER", overrides = { FontSize = 12 }, offsetY = 0, anchorX = "RIGHT", anchorY = "CENTER" },
                                DamageDone = { posY = 0,     offsetX = 4,    justifyH = "RIGHT", posX = 95.5,   selfAnchorY = "CENTER", overrides = { FontSize = 12 }, offsetY = 0, anchorX = "RIGHT", anchorY = "CENTER" },
                            },
                        },
                        [2] = {
                            id = 2, meterType = 2, sessionType = 1, viewMode = "chart",
                            barCount = 3, barWidth = 219, barHeight = 20, barGap = 1,
                            iconPosition = 1, style = 100, border = 3, background = 3,
                            title = 2, titleSize = 14, scrollOffset = 0,
                            anchor = { target = "OrbitDamageMeter1", align = "CENTER", padding = 42, edge = "TOP", fallback = "OrbitDamageMeter1" },
                            disabledComponents = { "Status" },
                            componentPositions = {
                                Rank       = { posY = -0.85, offsetX = 3.79, justifyH = "LEFT",  posX = -90.88, selfAnchorY = "CENTER", overrides = { FontSize = 8 },  offsetY = 0, anchorX = "LEFT",  anchorY = "CENTER" },
                                Name       = { posY = 0,     offsetX = 15,   justifyH = "LEFT",  posX = -84.5,  selfAnchorY = "CENTER", overrides = { FontSize = 12 }, offsetY = 0, anchorX = "LEFT",  anchorY = "CENTER" },
                                DPS        = { posY = 0,     offsetX = 52,   justifyH = "RIGHT", posX = 47.5,   selfAnchorY = "CENTER", overrides = { FontSize = 12 }, offsetY = 0, anchorX = "RIGHT", anchorY = "CENTER" },
                                DamageDone = { posY = 0,     offsetX = 4,    justifyH = "RIGHT", posX = 95.5,   selfAnchorY = "CENTER", overrides = { FontSize = 12 }, offsetY = 0, anchorX = "RIGHT", anchorY = "CENTER" },
                            },
                        },
                        [-1] = {
                            id = -1, isMaster = true, meterType = 1, sessionType = 1, viewMode = "chart",
                            barCount = 1, barWidth = 220, barHeight = 28, barGap = 1,
                            iconPosition = 2, style = 100, border = 2, background = 2,
                            title = 1, titleSize = 12, scrollOffset = 0,
                            anchor = { target = "OrbitMinimapContainer", align = "CENTER", padding = 2, edge = "BOTTOM", fallback = "OrbitMinimapContainer" },
                            disabledComponents = { "Status", "Rank", "DamageDone" },
                            componentPositions = {
                                Rank       = { offsetX = 4,  justifyH = "LEFT",  offsetY = 0, anchorX = "LEFT",  anchorY = "CENTER" },
                                Name       = { posY = 0, offsetX = 5,  justifyH = "LEFT",  posX = -91, selfAnchorY = "CENTER", overrides = { FontSize = 18 }, offsetY = 0, anchorX = "LEFT",  anchorY = "CENTER" },
                                DPS        = { posY = 0, offsetX = 10, justifyH = "RIGHT", posX = 75,  selfAnchorY = "CENTER", overrides = { FontSize = 16 }, offsetY = 0, anchorX = "RIGHT", anchorY = "CENTER" },
                                DamageDone = { offsetX = 4,  justifyH = "RIGHT", offsetY = 0, anchorX = "RIGHT", anchorY = "CENTER" },
                            },
                        },
                    },
                },
            ...
            ["Orbit_Minimap"] = {
                ["Orbit_Minimap"] = {
                    ...
                    DifficultyDisplay = "icon", DifficultyShowBackground = false, ZoneTextColoring = true, DisabledComponents = { "Status", "Zoom", "Coords" },
                    ComponentPositions = {
                        Compartment = { anchorX = "RIGHT", anchorY = "BOTTOM", offsetX = 15, offsetY = 15, posX = 95, posY = -95, justifyH = "RIGHT", selfAnchorY = "BOTTOM" },
                        Zoom = { anchorX = "RIGHT", anchorY = "BOTTOM", offsetX = 15, offsetY = 35, posX = 110, posY = -90, justifyH = "RIGHT", selfAnchorY = "BOTTOM" },
                        Missions = { anchorX = "LEFT", anchorY = "BOTTOM", offsetX = 20, offsetY = 20, posX = -90, posY = -90, justifyH = "CENTER", selfAnchorY = "BOTTOM" },
                        Coords = { anchorX = "RIGHT", anchorY = "BOTTOM", offsetX = 30, offsetY = 10, posX = 95, posY = -115, justifyH = "RIGHT", selfAnchorY = "BOTTOM" },
                        CraftingOrder = { anchorX = "RIGHT", anchorY = "TOP", offsetX = 20, offsetY = 38, posX = 90, posY = 72, justifyH = "CENTER", selfAnchorY = "TOP" },
                        DifficultyIcon = { anchorX = "LEFT", anchorY = "TOP", offsetX = 15, offsetY = 20, posX = -95, posY = 90, justifyH = "LEFT", selfAnchorY = "TOP", overrides = { IconSize = 42 } },
                        Mail = { anchorX = "RIGHT", anchorY = "TOP", offsetX = 20, offsetY = 20, posX = 90, posY = 90, justifyH = "CENTER", selfAnchorY = "TOP" },
                        DifficultyText = { anchorX = "LEFT", anchorY = "TOP", offsetX = 20, offsetY = 20, posX = -105, posY = 105, justifyH = "LEFT", selfAnchorY = "TOP" },
                        Clock = { anchorX = "CENTER", anchorY = "BOTTOM", offsetX = 0, offsetY = 10, posX = 0, posY = -100, justifyH = "CENTER", selfAnchorY = "BOTTOM" },
                        ZoneText = { anchorX = "CENTER", anchorY = "TOP", offsetX = 0, offsetY = 10, posX = 0, posY = 100, justifyH = "CENTER", selfAnchorY = "TOP", overrides = { FontSize = 18 } },
                    },
                    Position = { y = -3, x = -3, point = "TOPRIGHT" },
                },
            },
            ["Orbit_FocusFrame"] = {
                [3] = {
                ...
                [1] = {
                    ...
                    Tiers = {
                        Mythic = {
                            ...
                            ShowPowerBar = true,
                            DispelFrequency = 0.2,
                            DisabledComponents = { "CrowdControlIcon", "HealerAura1", "HealerAura2", "HealerAura3", "HealerAura4", "HealerAura5", "HealerAura6", "HealerAura7", "HealerAura8", "HealerAura9", "HealerAura10", "RaidBuff", "Status", "Debuffs" },
                            DispelColorPoison = { a = 1, r = 0, g = 0.6, b = 0 },
                            DispelNumLines = 8,
                            Width = 100,
                            DispelThickness = 2, DispelBorder = true, DispelLength = 30,
                        ...
                        Party = {
                            ...
                            ShowPowerBar = true,
                            Width = 160,
                            DisabledComponents = { "CrowdControlIcon", "HealerAura1", "HealerAura2", "HealerAura3", "HealerAura4", "HealerAura5", "HealerAura6", "HealerAura7", "HealerAura8", "HealerAura9", "HealerAura10", "RaidBuff", "Status" },
                            DispelColorPoison = { a = 1, r = 0, g = 0.6, b = 0 },
                        ...
                        World = {
                            ...
                            ShowPowerBar = false,
                            ShowHealthValue = false,
                            DisabledComponents = { "CrowdControlIcon", "HealerAura1", "HealerAura2", "HealerAura3", "HealerAura4", "HealerAura5", "HealerAura6", "HealerAura7", "HealerAura8", "HealerAura9", "HealerAura10", "RaidBuff", "Status", "Debuffs", "DefensiveIcon", "Buffs" },
                            Width = 65,
            ...
            ["Orbit_ActionBars"] = {
                ...
                [9] = { Scale = 80, OutOfCombatFade = false, HideEmptyButtons = true, Anchor = { target = "OrbitActionBar2", padding = 2, edge = "TOP", align = "CENTER" }, Opacity = 100, IconPadding = 2, Rows = 1, IconSize = 24 },
            ...
            ["Orbit_PlayerFrame"] = {
                [1] = {
                    ...
                    ComponentPositions = {
                        LevelText = { posY = 12.87, offsetX = 5, justifyH = "LEFT", posX = 74.86, selfAnchorY = "TOP", offsetY = 6, anchorX = "RIGHT", anchorY = "TOP" },
                        GroupPositionText = { posY = -12.87, offsetX = 5, justifyH = "LEFT", posX = 74.86, selfAnchorY = "BOTTOM", offsetY = 6, anchorX = "RIGHT", anchorY = "BOTTOM" },
                        LeaderIcon = { posY = 18.87, offsetX = 10, justifyH = "LEFT", posX = -69.86, selfAnchorY = "TOP", overrides = { Scale = 1.1, LeaderIconStyle = "header" }, offsetY = 0, anchorX = "LEFT", anchorY = "TOP" },
                        PvpIcon = { posY = -23.87, selfAnchorY = "BOTTOM", anchorX = "RIGHT", justifyH = "RIGHT", posX = 54.86, overrides = { IconSize = 22 }, offsetY = -5, offsetX = 25, anchorY = "BOTTOM" },
                        HealthText = { posY = 0, offsetX = 4.9, justifyH = "RIGHT", posX = 74.96, selfAnchorY = "CENTER", overrides = { FontSize = 14, HealthTextMode = "percent_short", ShowHealthValue = true }, offsetY = 0, anchorX = "RIGHT", anchorY = "CENTER" },
                        RestingIcon = { posY = 21.87, selfAnchorY = "TOP", anchorX = "RIGHT", justifyH = "LEFT", posX = 81.86, overrides = { Scale = 0.6 }, offsetY = -3, offsetX = -2, anchorY = "TOP" },
                        Name = { posY = 0, offsetX = 5, justifyH = "LEFT", posX = -74.86, selfAnchorY = "CENTER", overrides = { FontSize = 14 }, offsetY = 0, anchorX = "LEFT", anchorY = "CENTER" },
                        ...
                        MarkerIcon = { posY = 18.87, offsetX = 0, justifyH = "CENTER", posX = 0, selfAnchorY = "TOP", overrides = { Scale = 1 }, offsetY = 0, anchorX = "CENTER", anchorY = "TOP" },
                    },
            ...
            ["Orbit_PlayerDebuffs"] = {
                [1] = {
                    Spacing = 0, IconLimit = 10,
                    Anchor = { target = "OrbitMinimapContainer", fallback = "OrbitMinimapContainer", padding = 2, edge = "LEFT", align = "TOP" },
                },
            },
            ["Orbit_PlayerPower"] = {
                [1] = {
                    ShowText = false, Height = 16, Anchor = { target = "OrbitPlayerResources", padding = 2, edge = "TOP", align = "CENTER" },
                    DisabledComponents = { "Status" },
                    ComponentPositions = { Text = { justifyH = "RIGHT", posY = 0, offsetX = 5, posX = 135, selfAnchorY = "CENTER", offsetY = 0, anchorX = "RIGHT", anchorY = "CENTER" } },
                    Width = 204,
                },
            },
            ["Orbit_PlayerResources"] = {
                [1] = {
                    ...
                    ComponentPositions = {
                        HealthText = { justifyH = "CENTER", posY = 0, offsetX = 0, posX = 0, selfAnchorY = "CENTER", offsetY = 0, anchorX = "CENTER", anchorY = "CENTER" },
                    },
                },
            },
            ["Orbit_Portal"] = {
                [1] = {
                    Anchor = false, Position = { y = 0, x = 8.21, point = "LEFT" },
                    Compactness = 0, FadeEffect = 10, IconSize = 32, MaxVisible = 9, Spacing = 5,
                    DisabledComponents = { "DungeonShort", "Status" },
                    ComponentPositions = {
                        Timer         = { justifyH = "CENTER", posY = 0,   offsetX = 0, posX = 0,  selfAnchorY = "CENTER", offsetY = 0,  anchorX = "CENTER", anchorY = "CENTER" },
                        FavouriteStar = { justifyH = "RIGHT",  posY = 15,  offsetX = 1, posX = 15, selfAnchorY = "TOP",    offsetY = 1,  anchorX = "RIGHT",  anchorY = "TOP" },
                        DungeonScore  = { justifyH = "CENTER", posY = -18, offsetX = 0, posX = 0,  selfAnchorY = "BOTTOM", offsetY = -2, anchorX = "CENTER", anchorY = "BOTTOM" },
                    },
                },
            },
            ["Orbit_TargetBuffs"] = {
            ...
            ["Orbit_TargetFrame"] = {
                [2] = {
                    PortraitMirror = true, AuraSize = 20, Is3D = false, PortraitStyle = "2d", DisabledComponents = { "Portrait" },
                    ...
                    PortraitScale = 125,
                    ComponentPositions = {
                        RareEliteIcon = { posY = -7.78, offsetX = -8, justifyH = "LEFT", posX = 86.77, selfAnchorY = "BOTTOM", offsetY = 10, anchorX = "RIGHT", anchorY = "BOTTOM" },
                        Name = { posY = 0, offsetX = 5, justifyH = "LEFT", posX = -73.77, selfAnchorY = "CENTER", overrides = { FontSize = 14 }, offsetY = 0, anchorX = "LEFT", anchorY = "CENTER" },
                        Portrait = { offsetX = 4, offsetY = 0, anchorX = "LEFT", anchorY = "CENTER" },
                        MarkerIcon = { posY = 17.78, offsetX = 0, justifyH = "CENTER", posX = 0, selfAnchorY = "TOP", offsetY = 0, anchorX = "CENTER", anchorY = "TOP" },
                        HealthText = { posY = 0, offsetX = 5, justifyH = "RIGHT", posX = 73.77, selfAnchorY = "CENTER", offsetY = 0, anchorX = "RIGHT", anchorY = "CENTER" },
                        LevelText = { posY = 11.78, offsetX = -3, justifyH = "LEFT", posX = 81.77, selfAnchorY = "TOP", offsetY = 6, anchorX = "RIGHT", anchorY = "TOP" },
                    },
            ...
            ["Orbit_Datatexts"] = {
                [1] = {
                    datatextPositions = {
                        Performance = { placed = true, x = -575, y = 61, point = "BOTTOMRIGHT", scale = 1 },
                        Spec = { placed = true, x = 591, y = 56, point = "BOTTOMLEFT", scale = 1 },
                        Hearthstone = { placed = true, x = -527, y = 45, point = "BOTTOMRIGHT", scale = 1.23 },
                        CombatTimer = { placed = true, x = 377, y = 65, point = "BOTTOMLEFT", scale = 1.83 },
