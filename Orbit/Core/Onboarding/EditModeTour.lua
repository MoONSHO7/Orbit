...
tip.title:SetWidth(Engine.Pixel:Snap(TOOLTIP_MAX_WIDTH - TOOLTIP_PAD * 2 - 4, tip:GetEffectiveScale()))
...
tip.text:SetWidth(Engine.Pixel:Snap(TOOLTIP_MAX_WIDTH - TOOLTIP_PAD * 2 - 4, tip:GetEffectiveScale()))
...
canvasTip:Hide()
Engine.Pixel:Enforce(canvasTip)
...
canvasTip.title:SetWidth(Engine.Pixel:Snap(TOOLTIP_MAX_WIDTH - TOOLTIP_PAD * 2 - 4, canvasTip:GetEffectiveScale()))
...
canvasTip.text:SetWidth(Engine.Pixel:Snap(TOOLTIP_MAX_WIDTH - TOOLTIP_PAD * 2 - 4, canvasTip:GetEffectiveScale()))
...
drawerTip:Hide()
Engine.Pixel:Enforce(drawerTip)
...
drawerTip.title:SetWidth(Engine.Pixel:Snap(TOOLTIP_MAX_WIDTH - TOOLTIP_PAD * 2 - 4, drawerTip:GetEffectiveScale()))
...
drawerTip.text:SetWidth(Engine.Pixel:Snap(TOOLTIP_MAX_WIDTH - TOOLTIP_PAD * 2 - 4, drawerTip:GetEffectiveScale()))
