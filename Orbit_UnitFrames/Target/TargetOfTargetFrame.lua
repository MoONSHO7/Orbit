...
function Plugin:OnLoad()
    ...
    if OrbitEngine.ComponentDrag and self.frame.Name then
        OrbitEngine.ComponentDrag:Attach(self.frame.Name, self.frame, {
            key = "Name",
            onPositionChange = OrbitEngine.ComponentDrag:MakePositionCallback(self, TOT_FRAME_INDEX, "Name"),
        })
    end
    ...
    if self.frame.HealthText then
        OrbitEngine.ComponentDrag:Attach(self.frame.HealthText, self.frame, {
            key = "HealthText",
            onPositionChange = OrbitEngine.ComponentDrag:MakePositionCallback(self, TOT_FRAME_INDEX, "HealthText"),
        })
    end
